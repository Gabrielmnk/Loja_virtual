...
<body>
    <div class="d-flex flex-column wrapper">
        <nav class="navbar navbar-expand-lg navbar-dark border-bottom shadow-sm mb-3" style="background-color: #8B4513;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <span class="badge rounded-pill bg-light position-absolute ms-4 mt-0" title="0 produto(s) no carrinho" style="color:#8B4513 ;"><small>0</small></span>
